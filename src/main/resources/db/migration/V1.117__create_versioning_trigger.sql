-- function from Temporal Tables Version: 0.4.0
-- This is an attempt to rewrite the postgresql temporal_tables extension in PL/pgSQL,
-- without the need for external c extension.
-- see https://github.com/nearform/temporal_tables
-- file: https://github.com/nearform/temporal_tables/blob/master/versioning_function.sql
