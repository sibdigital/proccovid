...
/**
 * Доля в уставном капитале (складочном капитале, уставном фонде, паевом фонде), содержащиеся в ЕГРЮЛ
 * 
...
public class ДоляУстКапЕГРЮЛТип {
    ...
    protected ДоляУстКапЕГРЮЛТип.РазмерДоли размерДоли;
     ...
     * @return
     *     possible object is
     *     {@link ДоляУстКапЕГРЮЛТип.РазмерДоли }
     *     
     */
    public ДоляУстКапЕГРЮЛТип.РазмерДоли getРазмерДоли() {
        return размерДоли;
    }
     ...
     *     
     */
    public void setРазмерДоли(ДоляУстКапЕГРЮЛТип.РазмерДоли value) {
